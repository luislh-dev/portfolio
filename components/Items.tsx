  ...
  return (
    <div className={clsx('flex flex-row gap-6', 'md:gap-12 lg:gap-24')}>
      <div className={clsx('hidden', 'md:block md:pb-24 md:w-32 lg:w-40')}>
        <div className={clsx('mt-4 pt-[5.5px] md:sticky md:top-[86px]', 'fm:relative fm:top-0')}>
          <div
            className={clsx(
      ...
      <div
        className={clsx('border-divider-light items-stretch border', 'dark:border-divider-dark')}
      />
      <div className={clsx('flex min-w-0 flex-1 flex-col gap-16 py-8', 'md:gap-0 md:py-4')}>
        {children}
      </div>
    </div>
  );
