...
function ActionCenterButton({
  ...
  return (
    ...
    >
      ...
      <div className={clsx('text-left text-[13px] font-medium', 'dark:font-normal')}>{title}</div>
    </button>
  );
}
      ...
      <div className={clsx('flex flex-1 flex-col gap-8 p-2')}>
        <m.div className={clsx('flex h-24 gap-4')} variants={animation}>
          <ActionCenterButton
            ...
            icon={
              <m.div
                animate={theme === 'dark' ? { rotate: [90, 0] } : { rotate: [90.01, 0] }}
              ...
              >
                ...
                >
                  {theme === 'dark' ? (
                    <Dark className={clsx('h-5 w-5')} />
                  ) : (
                    <Light className={clsx('h-5 w-5')} />
                  )}
                </m.div>
                <m.div
                  animate={
                ...
                >
                  {theme === 'dark' ? (
                    <Light className={clsx('h-5 w-5 -rotate-90')} />
                  ) : (
                    <Dark className={clsx('h-5 w-5 -rotate-90')} />
                  )}
                </m.div>
              </m.div>
            }
