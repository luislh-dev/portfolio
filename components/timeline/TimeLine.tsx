...
export function TimeLine() {
  return (
    <section className='content-wrapper relative flex-shrink-0 overflow-hidden py-20 lg:overflow-visible'>
      ...
      <div className='space-y-20 pl-8 sm:pl-6 md:pl-8 lg:pl-0'>
        {dataExperience.map((ex, index) => (
          ...
          >
            ...
            <div className='relative max-h-max w-full lg:w-1/2'>
              {/* Línea que conecta desde la línea vertical al contenido */}
              <div
                className={`absolute -left-8 top-12 h-0.5 w-8 bg-blue-600 sm:-left-14 sm:w-14 lg:w-12 ${
