...
export function SectionButton({
  ...
  return (
    <button
      type='button'
      className={clsx(
        'flex flex-1 items-center gap-4 rounded-2xl border-2 bg-white px-4 py-4 text-left dark:bg-slate-900',
        active
      ...
      {icon && (
        <span
          className={clsx(
            ...
            active ? ['text-blue-600 dark:text-blue-400'] : ['text-slate-40 dark:text-slate-600']
          )}
        >
          {icon}
        </span>
        ...
        <span
          className={clsx(
            ...
            active
              ...
              : ['text-slate-70 dark:text-slate-200']
          )}
        >
          {title}
        </span>
